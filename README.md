...
- GenAI tasks and assignments  
- Prompt engineering experiments  
- Model testing and output analysis  
- Small AI-driven projects and scripts  

## Purpose

To document my growth in Generative AI, showcase my work, and maintain a clean reference of everything I build during the internship.
---  
🙋‍♂️ BHUVANESH M  
